(function() {
  var STEP, SomeMagic, Static, a, addIm, addImAfterTwenty, anim, arrayPsImageAdder, body, canvas, circle, circle2, color, customContainer, data, f1, fullyMatrix, gui, j, lendth, matrixCX, matrixCXover, nowMath, offsetX, offsetY, onKeyDownHandler, results, size, text, update;
...
//   };
  ...
  //addIm('common.jpg', [$(window).width()/2,$(window).height()/2]);
  canvas.setBackgroundImage('common.jpg', canvas.renderAll.bind(canvas), {
